...
- (id)initWithScrollFrame:(CGRect)scrollFrame withHeaderHeight:(int)height andContentText:(NSString *)contentText
{
    ...
    if(self)
    {
        ...
        CGFloat headFontSize      = 18;
        if (INTERFACE_IS_PAD) {
            headFontSize          = 24;
        }

        [self.headerLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:headFontSize]];
        [self.headerLabel setFrame:CGRectMake(MMParallaxPresenterContentLabelPadding, self.headerHeight / 2 - headFontSize - MMParallaxPresenterHeaderTitlePadding, scrollFrame.size.width - (MMParallaxPresenterHeaderTitlePadding * 2), headFontSize + 10)];
...
- (id)initWithScrollFrame:(CGRect)scrollFrame withHeaderHeight:(int)height withContentText:(NSString *)contentText andContextImage:(UIImage *)image
{
    ...
    if(self)
    {
        ...
        [self.headerLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:headFontSize]];
        [self.headerLabel setFrame:CGRectMake(MMParallaxPresenterContentLabelPadding, self.headerHeight - headFontSize - MMParallaxPresenterHeaderTitlePadding, scrollFrame.size.width - (MMParallaxPresenterHeaderTitlePadding * 2), headFontSize + 10)];
        [self.headerLabel setText:@"Default Title"];
        [self.headerLabel setTextColor:[UIColor whiteColor]];
        [self.headerLabel setTextAlignment:NSTextAlignmentRight];
        [self.headerView addTitle:self.headerLabel];
        ...
        [self.contentLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:contentFontSize]];
...
- (id)initWithScrollFrame:(CGRect)scrollFrame withHeaderHeight:(int)height andContentView:(UIView *)contentView
{
    ...
    if(self)
    {
        ...
        self.headerLabel.adjustsFontSizeToFitWidth = YES;
        [self.headerLabel setFont:[UIFont fontWithName:@"HelveticaNeue-Thin" size:headFontSize]];
        [self.headerLabel setFrame:CGRectMake(MMParallaxPresenterHeaderTitlePadding, self.headerHeight - headFontSize - MMParallaxPresenterHeaderTitlePadding, scrollFrame.size.width - (MMParallaxPresenterHeaderTitlePadding * 2), headFontSize + 10)];
        [self.headerLabel setText:@"Default Title"];
        [self.headerLabel setTextColor:[UIColor whiteColor]];
        [self.headerLabel setTextAlignment:NSTextAlignmentRight];
        [self.headerView addTitle:self.headerLabel];
...
- (void)setupTitleFrame
{
    ...
    {
        [self.headerLabel setFrame:CGRectMake(MMParallaxPresenterHeaderTitlePadding, self.headerHeight - headFontSize - MMParallaxPresenterHeaderTitlePadding, self.headerLabel.frame.size.width, self.headerLabel.frame.size.height)];
    ...
    else if(self.titleAlignment == MMParallaxPageTitleNSTexCentertAlignment)
    {
        [self.headerLabel setFrame:CGRectMake(MMParallaxPresenterHeaderTitlePadding, self.headerHeight - headFontSize - MMParallaxPresenterHeaderTitlePadding, self.headerLabel.frame.size.width, self.headerLabel.frame.size.height)];
