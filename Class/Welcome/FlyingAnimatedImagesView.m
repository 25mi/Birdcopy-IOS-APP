...
@interface FlyingAnimatedImagesView()
{
    BOOL animating;
...
@implementation FlyingAnimatedImagesView
...
- (void)bringNextImage
{
    ...
    NSUInteger nextImageToShowIndex;
...
- (void)setDelegate:(id<FlyingAnimatedImagesViewDelegate>)delegate
{
