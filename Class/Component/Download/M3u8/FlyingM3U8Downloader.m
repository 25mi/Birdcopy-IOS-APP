...
-(id)initWithM3U8List:(FlyingM3U8List *)list
{
    ...
    if(self != nil)
    {
        ...
        _saveTo = [iFlyingAppDelegate getLessonDir:self.playlist.lessonID];
    ...
    @autoreleasepool {
        ...
        if (segment) {
            ...
            if (segment.duration==0) {
                ...
                NSURL *webURL = [NSURL URLWithString:[segment.locationUrl stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
                ...
                _operation = [[AFDownloadRequestOperation alloc] initWithRequest:request targetPath:localURL shouldResume:YES];
                [_operation setShouldOverwrite:YES];
                [_operation setDeleteTempFileOnCancel:YES];
                ...
                [_operation setCompletionBlockWithSuccess:^(AFHTTPRequestOperation *operation, id responseObject) {
                    ...
                    if( error.code== NSURLErrorNotConnectedToInternet || error.code==  NSURLErrorCannotConnectToHost || error.code== NSURLErrorNetworkConnectionLost){
                    ...
                    [appDelegate closeAndReleaseDownloaderForID:lessonID];
                }];
                [_operation start];
                _M3u8OrdeID++;
            }
