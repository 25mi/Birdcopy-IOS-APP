...
//学习目标管理
enum {
    BirdEnglishLevelBaby=0,      //0-800
    BirdEnglishLevelChild,       //800-1500
    BirdEnglishLevelPrimary,     //1500-2000
    BirdEnglishLevelSecondary,   //2000-5000
    BirdEnglishLevelHighschool,  //5000-10000
    BirdEnglishLevelCollege,     //10000-20000
    BirdEnglishLevelMaster       //20000-~
};
typedef NSInteger American_Local_Word_Level;
...
//#define KServerNetAddress         @"http://j.birdcopy.com"
//#define KSubServerAddress         @"http://j.birdcopy.com"
