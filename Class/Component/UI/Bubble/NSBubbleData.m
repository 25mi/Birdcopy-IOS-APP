...
{    
    ...
    CGFloat tempsize = [UIFont systemFontSize];
    ...
    if (INTERFACE_IS_PAD ) {
        ...
        constraint =CGSizeMake(440, MAXFLOAT);
    }

    UILabel *gettingSizeLabel = [[UILabel alloc] init];
    gettingSizeLabel.font = font;
    gettingSizeLabel.text = (text ? text : @"");
    gettingSizeLabel.numberOfLines = 0;
    gettingSizeLabel.lineBreakMode = NSLineBreakByWordWrapping;
    
    CGSize expectSize = [gettingSizeLabel sizeThatFits:constraint];

    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, expectSize.width, expectSize.height)];
