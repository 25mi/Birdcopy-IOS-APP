...
@implementation FlyingEventAuthorCell
...
{
    FlyingEventAuthorCell * cell = [[[NSBundle mainBundle] loadNibNamed:@"FlyingEventAuthorCell" owner:self options:nil] objectAtIndex:0];
