//
//  FlyingMemberCollectionViewCell.m
//  FlyingEnglish
//
...
@implementation FlyingMemberCollectionViewCell

+ (FlyingMemberCollectionViewCell*) memberCollectionViewCell
{
    FlyingMemberCollectionViewCell * cell = [[[NSBundle mainBundle] loadNibNamed:@"FlyingMemberCollectionViewCell" owner:self options:nil] objectAtIndex:0];
